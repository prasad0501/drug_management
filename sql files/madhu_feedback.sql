...
CREATE TABLE `feedback` (
  ...
  PRIMARY KEY (`userid1`),
  CONSTRAINT `userid1` FOREIGN KEY (`userid1`) REFERENCES `signup` (`userid`) ON DELETE CASCADE ON UPDATE NO ACTION
...
INSERT INTO `feedback` VALUES ('nice','mark'),('good work','prasad0501');
